...
class Point(object):
    ...
    def _set_magnitude(self, magnitude):
        self.x = magnitude * math.cos(self.angle * math.pi / 180.0)
        self.y = magnitude * math.sin(self.angle * math.pi / 180.0)
    ...
    def _set_angle(self, angle):
        self.x = self.magnitude * math.cos(angle * math.pi / 180.0)
        self.y = self.magnitude * math.sin(angle * math.pi / 180.0)
    ...
    def _set_polar(self, coords):
        self.x = coords[0]*math.cos(coords[1] * math.pi / 180.0)
        self.y = coords[0]*math.sin(coords[1] * math.pi / 180.0)
...
class Xform(object):
    ...
    def scale_x(self, scale):
        self._x.magnitude *= scale

    def scale_y(self, scale):
        self._y.magnitude *= scale
